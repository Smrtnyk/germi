...
fn init_app_state(
    ...
    app.manage(AppState {
        ...
        flow_filter_search_epoch: Arc::new(std::sync::atomic::AtomicU64::new(0)),
        filter_window_sessions: std::sync::Mutex::new(state::FilterWindowSessions::default()),
        ...
        pending_har_rules: Arc::new(std::sync::Mutex::new(state::PendingHarRules::default())),
        capture_import_batch_acks: Arc::new(
            std::sync::Mutex::new(std::collections::HashMap::new()),
        ),
        launch_capture: launch::PendingCapture::new(launch.capture),
        prepared_launch_capture: Arc::new(std::sync::Mutex::new(None)),
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::search_flow_filters,
            commands::cancel_flow_filter_search,
            commands::register_filter_window_session,
            ...
            commands::reserve_capture_import,
            commands::reserve_launch_capture_import,
            commands::cancel_capture_import,
            commands::ack_capture_import_batch,
