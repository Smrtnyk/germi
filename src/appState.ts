...
export function useAppState(flushInlineRules: () => Promise<void> = () => Promise.resolve()) {
  ...
  return {
    ...
    notificationHistory: toasts.history,
    unreadNotifications: toasts.unreadCount,
    markNotificationRead: toasts.markRead,
    markAllNotificationsRead: toasts.markAllRead,
    clearNotificationHistory: toasts.clearHistory,
